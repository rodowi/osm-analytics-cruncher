...
tileReduce({
    ...
    maxWorkers: Math.max(1, Math.floor(cpus/4)*4 - 1) // make sure the number of threads is not divisible by 4 to make sure that there's no bias for the top-left tile at a particular worker
})
